  ...
  React.useEffect(() => {
    if (typeof window !== 'undefined' && typeof document !== 'undefined') {
      import('openseadragon').then(OpenSeaDragon => {
        ...
        const tileSources = [
          "https://digitalcollections-staging.tricolib.brynmawr.edu/cantaloupe/iiif/2/https%3A%2F%2Fdigitalcollections-staging.tricolib.brynmawr.edu%2F_flysystem%2Ffedora%2F2022-06%2F160-Service%2520File.jpg/full/full/default.jpg"
        ];
        // Create the viewer.
